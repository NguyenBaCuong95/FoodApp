...
import com.example.foodorderapp.databinding.CartfragmentAdminBinding;
...
public class AdminCartFragment extends Fragment {
    private CartfragmentAdminBinding mFragmentAdminOrderBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mFragmentAdminOrderBinding = CartfragmentAdminBinding.inflate(inflater, container, false);
        initView();
        getListOrders();
